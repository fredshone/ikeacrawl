...
impl State {
    ...
    fn advance_level(&mut self) {
        ...
        if map_level == 2 {
            spawn_amulet_of_yala(&mut self.ecs, map_builder.amulet_start);  // TODO refactor amulet_start as furthest point
        } else {
            let exit_idx = map_builder.map.point2d_to_index(map_builder.amulet_start); map_builder.map.tiles[exit_idx] = TileType::Exit;
        }
...
fn main() -> BError {
    let context = BTermBuilder::new()
        .with_title("IKEA Crawler")
        .with_fps_cap(30.0)
        .with_dimensions(DISPLAY_WIDTH, DISPLAY_HEIGHT)
        .with_tile_dimensions(32, 32)
        .with_resource_path("resources/")
        .with_font("acidfont.png", 32, 32)
        .with_font("terminal8x8.png", 8, 8)
        .with_simple_console(DISPLAY_WIDTH, DISPLAY_HEIGHT, "acidfont.png")
        .with_simple_console_no_bg(DISPLAY_WIDTH, DISPLAY_HEIGHT, "acidfont.png")
